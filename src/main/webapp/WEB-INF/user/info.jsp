    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="updateUserInfo.do" method="post" class="main_form">
                ...
                <div class="input_info"><input type="text" readonly="readonly" class="readonly" name="adminId" value="${admin.adminId }" /></div>
                <div class="text_info clearfix"><span>角色：</span></div>
                <div class="input_info">
                    <input type="text" readonly="readonly" class="readonly width400" value="${admin.adminCode }" />
                </div>
                ...
                <div class="button_info clearfix">
                    ...
                    <input type="button" value="取消" class="btn_save" onclick="location=history.back()" />
                </div>
            </form>  
        </div>
        <!--主要区域结束-->
