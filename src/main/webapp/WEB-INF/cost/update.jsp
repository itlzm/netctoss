        ...
        <div id="main">            
            ...
            <form action="updateCost.do" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="costType" ${cost.costType=='1'?'checked':'' } value="1" id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="costType" ${cost.costType=='2'?'checked':'' } value="2" id="package" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="costType" ${cost.costType=='3'?'checked':'' } value="3" id="timeBased" onclick="feeTypeChange(3);" />
