        ...
        <script language="javascript" type="text/javascript">
            ...
            function deleteFee(id) {
                ...
                if(r){
                	...
                	location.href='deleteCost.do?cost_id='+id;
                }
            }
        </script>        
    </head>
                ...
                <div id="data">  
	                    <table id="datalist">
	                        ...
	                        <c:forEach items="${costs }" var="c">                     
		                        <tr>
		                            <td>${c.costId }</td>
		                            <td><a href="detailCost.do?cost_id=${c.costId }">${c.name }</a></td>
		                            ...
		                            <td>                                
		                                ...
		                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdateCost.do?cost_id=${c.costId}';" />
	                                	<input type="button" value="删除" class="btn_delete"  onclick='deleteFee(${c.costId})' />
		                            	<%-- 在deleteFee方法中传入参数costId，此方法中触发window.confirm事件，
		                            	如果返回true，会执行删除操作 --%>
		                            </td>
		                        </tr>
	                        </c:forEach> 
